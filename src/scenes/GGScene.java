...
public abstract class GGScene {
    ...
    /** 
     * Auxiliary list, sprites will add in graphic elements of scene.
     * 
     * @param GGSprite[] ss
     */
    public void attachSprite(GGSprite[] ss, int layer){
    	for(int i=0; i<ss.length; i++){
    		System.out.println(ss[i].position);
    		attachSprite(ss[i], layer);
    	}
    }
